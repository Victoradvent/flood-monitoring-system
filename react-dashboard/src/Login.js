          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-14 text-white">
            <div className="max-w-xl">
              <div className="mb-7 flex items-center gap-3">
                ...
                <span className="text-sm font-bold uppercase tracking-[.25em]">
                  FMS
                </span>
              </div>
              <h1 className="max-w-lg text-5xl font-extrabold leading-tight tracking-tight">
                Flood Monitoring
                <br />
                System
              </h1>
              <div className="mt-6 h-1 w-16 rounded-full bg-blue-300" />
              <p className="mt-6 max-w-md text-lg leading-8 text-blue-50">
                Real-time monitoring, alerts and intelligent risk management for
                a safer tomorrow.
              </p>
            </div>
            <div className="grid grid-cols-3 divide-x divide-white/25 rounded-xl border border-white/10 bg-slate-950/15 p-5 backdrop-blur-sm">
              <Feature
                icon="water"
                title={
                  <>
        ...
        <div className="flex items-center justify-center bg-white px-6 py-10 sm:px-12 lg:px-16">
          <div className="w-full max-w-[500px]">
            <div className="text-center">
              ...
              <h2 className="mt-7 text-3xl font-extrabold tracking-tight text-[#0b2e5b]">
                Welcome Back
              </h2>
            ...
            <form onSubmit={submit} className="mt-10 space-y-5">
              <label className="block">
                ...
                <div className="flex items-center gap-3 rounded-lg border border-slate-300 px-4 py-3.5 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100">
                  <Icon name="profile" size={21} className="text-slate-400" />
                  <input
              ...
              <label className="block">
                ...
                <div className="flex items-center gap-3 rounded-lg border border-slate-300 px-4 py-3.5 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100">
                  <Icon name="shield" size={21} className="text-slate-400" />
                  <input
                    className="w-full border-0 bg-transparent text-sm text-slate-800 outline-none placeholder:text-slate-400"
              ...
              <button
                disabled={loading}
                className="primary-btn w-full py-3.5 text-base"
              >
            ...
            <button
              ...
              className="secondary-btn w-full border-blue-300 py-3.5 text-blue-600 hover:bg-blue-50"
            >
              <Icon name="profile" />
              Login as Operator
            </button>
            <p className="mt-10 text-center text-xs text-slate-400">
              © 2025 Flood Monitoring System. All rights reserved.
            </p>
          </div>
        </div>
      </div>
...
function Feature({ icon, title }) {
  return (
    <div className="flex flex-col items-center gap-2 px-3 text-center">
      ...
      <span className="text-sm font-semibold leading-5 text-blue-50">
        {title}
      </span>
    </div>
  );
