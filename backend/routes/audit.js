  ...
  async (req, res) => {
    ...
    try {
      await logAudit(
        ...
        operatorId,
        "REPORT_VIEW",
        `Viewed logs with filters: start=${start}, end=${end}, operator=${operator}, action=${action}`,
      );
    } catch (err) {
  ...
  async (req, res) => {
    ...
    try {
      await logAudit(
        ...
        operatorId,
        "REPORT_EXPORT",
        `Exported logs with filters: start=${start}, end=${end}, operator=${operator}, action=${action}`,
      );
    } catch (err) {
